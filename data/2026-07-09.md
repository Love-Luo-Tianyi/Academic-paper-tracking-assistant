...
### [4] [Dynamic-in-Few-Step: Unifying Dynamic Computation and Few-Step Distillation for Efficient Video Generation](https://arxiv.org/abs/2607.06631)
...
### [5] [SPEAR: A Simulator for Photorealistic Embodied AI Research](https://arxiv.org/abs/2607.06701)
...
### [7] [Seeing What Matters: Lesion-Aware High-Resolution Patch Discovery and Fusion for Chest X-ray Report Generation](https://arxiv.org/abs/2607.06909)
...
### [8] [LoCA: Spatially-Aware Low-Rank Convolutional Adaptation of Vision Foundation Models](https://arxiv.org/abs/2607.06918)
...
### [9] [Compass: Prostate Cancer Detection Needs Multi-View Context](https://arxiv.org/abs/2607.06919)
...
### [10] [Bi-PT: Bidirectional Cross-Attention Point Transformers for Four-Chamber Heart Reconstruction from Sparse Cardiac MRI Data](https://arxiv.org/abs/2607.06923)
...
### [11] [General Incomplete Multimodal Learning via Dynamic Quality Perception](https://arxiv.org/abs/2607.06943)
...
### [12] [SpiS-GAN: Spiral-Modulated Handwriting Synthesis with Star Operation](https://arxiv.org/abs/2607.06949)
...
### [13] [HPR-SAM: Hierarchical Probabilistic Representation Learning for Prompt-free SAM-based Medical Image Segmentation](https://arxiv.org/abs/2607.06972)
...
### [14] [EdgeCompress: Coupling Multidimensional Model Compression and Dynamic Inference for EdgeAI](https://arxiv.org/abs/2607.06982)
...
### [15] [Ego-Human Motion Prediction with 3D-Aware LLM](https://arxiv.org/abs/2607.07001)
...
### [16] [AnchorPrune: Relevance-Anchored Contextual Expansion for Visual Token Pruning](https://arxiv.org/abs/2607.07033)
*Kyuan Oh,Bumsoo Kim*
...
### [20] [When Prompts Ignore Structure: Graph-Based Attribute Reasoning for Calibrated VLMs](https://arxiv.org/abs/2607.07395)
...
### [21] [Audio Sentiment Analysis via Distillation and Cross-Modal Integration of Generated Multilingual Transcripts](https://arxiv.org/abs/2607.06611)
...
### [22] [Healthier LLMs: Retrieval-Augmented Generation for Public Health Question Answering](https://arxiv.org/abs/2607.06641)
...
### [24] [From Text to Parameters: Predicting Item Parameters from Embedding Regularization with Reliability and Design Ceilings](https://arxiv.org/abs/2607.07141)
...
### [25] [Think Big, Search Small: Where Capacity Matters in Hierarchical Search Agents?](https://arxiv.org/abs/2607.07548)
...
### [26] [PALS: Percentile-Aware Layerwise Sparsity for LLM Pruning](https://arxiv.org/abs/2607.07557)
...
### [27] [Future Confidence Distillation in Large Language Models](https://arxiv.org/abs/2607.07626)
*Sahil Kale*
...
### [28] [Does Bielik Know What It Doesn't Know? Activation Dispersion Separates Entity Familiarity from Factual Reliability Across Model Scale](https://arxiv.org/abs/2607.07670)
*Grzegorz Brzezinka*
...
### [29] [From Noisy Traces to Root Causes: Structural Trajectory Analysis and Causal Extraction for Agent Optimization](https://arxiv.org/abs/2607.07702)
...
### [30] [Co-LMLM: Continuous-Query Limited Memory Language Models](https://arxiv.org/abs/2607.07707)
...
### [31] [What Semivalues Cannot See: The Information Content of Anonymous Marginal Values](https://arxiv.org/abs/2607.07013)
*Matthew Fried*
...
### [32] [Simple Nash Equilibria for Qualitative Multiplayer Games](https://arxiv.org/abs/2607.07151)
...
### [33] [Stable Matchings with Minimum Utility Gap](https://arxiv.org/abs/2607.07160)
*Yao Sheng,Yu Yokoi*
...
### [34] [Positional Determinacy with Colored Vertices: a 1-to-2-Player Lift](https://arxiv.org/abs/2607.07415)
...
### [35] [FedMark-FM: Auditable, Risk-Adjusted Data Markets for Federated Foundation-Model Adaptation](https://arxiv.org/abs/2607.07529)
...
### [36] [AgentLens: Production-Assessed Trajectory Reviews for Coding Agent Evaluation](https://arxiv.org/abs/2607.06624)
...
### [40] [Cost-Effective Agent Harnesses for Abstract Reasoning and Generalization on ARC-AGI-1](https://arxiv.org/abs/2607.06764)
...
### [41] [Does AI Understand Imaging? A Systematic Benchmark of Agentic AI for Computational Imaging Tasks](https://arxiv.org/abs/2607.07189)
...
### [43] [The Blind Curator: How a Biased Judge Silently Disables Skill Retirement in Self-Evolving Agents](https://arxiv.org/abs/2607.07436)
...
### [44] [Search, Fail, Recover: A Training Framework for Correction-Aware Reasoning](https://arxiv.org/abs/2607.07492)
...
### [45] [Do LLM-Generated Skills Make Better AI Data Scientists? A Component Ablation Across Data-Science Workflows](https://arxiv.org/abs/2607.07504)
*Wei-Jung Huang*
...
### [47] [Macroeconomic Message Passing for Anticipating Foreign Exchange Regime Changes: A Deep Logical Learning Approach using Graph Tsetlin Machines](https://arxiv.org/abs/2607.06719)
...
### [48] [Machine Learning-Based Battery State-of-health Prediction for Unmanned Aerial Vehicles Predictive Maintenance](https://arxiv.org/abs/2607.06791)
...
### [49] [Topological Signatures of Diffusive Release in Porous Media](https://arxiv.org/abs/2607.07061)
*Donghan Kim*
...
### [50] [Toward Deployable Satellite Anomaly Detection: A Benchmark Study on Large-Scale ESA-ADB Telemetry](https://arxiv.org/abs/2607.07335)
...
### [51] [When and How Should a Power Trader Engage in Arbitrage? Predict, then Contextually Optimize](https://arxiv.org/abs/2607.07351)
...
### [52] [Accelerating Industrial Finite Element Simulations of Electric Machines based on Runtime Analysis](https://arxiv.org/abs/2607.07514)
...
### [53] [Near-Optimal Lower Bounds on One-Bit Compressed Sensing of Approximately Sparse Signals](https://arxiv.org/abs/2607.06750)
...
### [54] [AirPASS: Over-the-Air Federated Learning via Pinching Antenna Systems](https://arxiv.org/abs/2607.06768)
...
### [55] [Four classes of few-weight self-orthogonal codes and their applications for LCD codes and quantum codes](https://arxiv.org/abs/2607.07181)
